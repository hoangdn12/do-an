...
<header class="header-style-1">
            ...
            <div class="header-top-inner">
                <div class="cnt-account">
                    <ul class="list-unstyled">
                        <li><a href="{{ route('contact') }}"><i class="fa fa-compress"></i> Liên hệ chúng tôi</a></li>
                        ...
                        <li><a href="{{ route('mycart') }}"><i class="icon fa fa-check"></i>Thanh toán</a></li>
                        <li>
                        @auth
                            <a href="{{ route('dashboard') }}"><i class="icon fa fa-user"></i>Tài khoản của bạn</a>
                        @else
                            <a href="{{ route('dashboard') }}"><i class="icon fa fa-lock"></i>Đăng nhập & Đăng kí</a>
                        @endauth
                        </li>
    ...
    <div class="main-header">
     ...
     <input class="search-field" onfocus="search_result_show()" onblur="search_result_hide()" id="search" name="search" placeholder="Tìm kiếm..." />
                ...
                <div class="col-xs-12 col-sm-12 col-md-2 animate-dropdown top-cart-row">
                    ...
                    <!--   // End Mini Cart Start with Ajax -->
                                ...
                                <div class="clearfix cart-total">
                                    <div class="pull-right"> <span class="text">Tổng cộng :</span>
                                        <span class='price'  id="cartSubTotal"> </span> 
                                    </div>

                                    <div class="clearfix"></div>
                                    <a href="{{ route('mycart') }}" class="btn btn-upper btn-primary btn-block m-t-20">Thanh toán</a> </div>
                                <!-- /.cart-total-->
                    ...
                    <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
                        <div class="nav-outer">
                            <ul class="nav navbar-nav">
                                <li class="active dropdown yamm-fw"> <a href="{{ asset('/') }}" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">Trang chủ</a> </li>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        @foreach($subcategories as $subcategory)
                                                            <div class="col-xs-12 col-sm-6 col-md-2 col-menu">
                                                                ...
                                                                @endforeach  <!--   // end subsubcate -->

                                                            </div>
                                                        @endforeach  <!--   // end subcate -->
