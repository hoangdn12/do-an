                ...
                <div class="col-md-12">
                    <div class="box bt-3 border-info">
                        <div class="box-header">
                            <h4 class="box-title"><strong>Cập nhật hành ảnh phụ sản phẩm</strong></h4>
                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <p class="card-text">
                                                <div class="form-group">
                                                    <label class="form-control-label">Chọn ảnh khác <span class="tx-danger">*</span></label>
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    <div class="box bt-3 border-info">
                        <div class="box-header">
                            <h4 class="box-title"><strong>Cập nhật hình ảnh chính sản phẩm</strong></h4>
                        </div>
