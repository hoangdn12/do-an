			...
			<div class="col-8">
			 ...
			 <div class="box">
				<div class="box-header with-border">
				  <h3 class="box-title">Danh mục tin tức <span class="badge badge-pill badge-danger"> {{ count($blogcategory) }} </span></h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
...
<!--   ------------ Add Blog Category Page -------- -->
 ...
 <form method="post" action="{{ route('blogcategory.store') }}" >
	 ...
	 <div class="form-group">
		<h5>Tên danh mục tin tức <span class="text-danger">*</span></h5>
		<div class="controls">
