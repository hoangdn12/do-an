        ...
        <section class="content">
            <div class="row">
                <div class="col-8">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">DANH SÁCH MÃ GIẢM GIÁ<span class="badge badge-pill badge-danger"></span></h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($item->coupon_validity >= Carbon\Carbon::now()->format('Y-m-d'))
		 	                                        <span class="badge badge-pill badge-success"> Hợp lệ </span>
                                                @else
                                                    <span class="badge badge-pill badge-danger"> Không hợp lệ </span>
                                                @endif
                                            </td>
                ...
                <div class="col-4">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Thêm mã giảm giá mới </h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="table-responsive">
                                <form method="post" action="{{ route('coupon.store') }}" >
                                    ...
                                    <div class="form-group">
                                        <h5>Tên mã giảm giá <span class="text-danger">*</span></h5>
                                        <div class="controls">
                                    ...
                                    <div class="form-group">
                                        <h5>Phần trăm giảm giá <span class="text-danger">*</span></h5>
                                        <div class="controls">
