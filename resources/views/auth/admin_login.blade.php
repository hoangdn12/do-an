...
<head>
  <meta charset="utf-8">
    ...
    <title>Quản trị website Flimart</title>
...
<body class="hold-transition theme-primary bg-gradient-primary">
	...
	<div class="content-top-agile p-10">
		<h2 class="text-white">Đăng nhập tài khoản</h2>
		<p class="text-white-50">quản trị website</p>							
	</div>
 ...
 <input type="password" id="password" name="password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Mật khẩu">
				</div>
			</div>
			  <!-- <div class="row">
				<div class="col-6">
