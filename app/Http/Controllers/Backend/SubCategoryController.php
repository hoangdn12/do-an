...
class SubCategoryController extends Controller
{
    ...
    public function SubCategoryStore(Request $request){
        ...
        $request->validate([
            ...
            'category_id.required' => 'Vui lòng chọn bất kỳ tùy chọn nào',
            'subcategory_name.required' => 'Hãy nhập tên danh mục con',
        ]);
...
//// sub -> sub///
    ...
    public function SubSubCategoryStore(Request $request){
        $request->validate([
            ...
            'category_id.required' => 'Vui lòng chọn bất kỳ tùy chọn nào',
            'subsubcategory_name.required' => 'Hãy nhập tên danh mục con',
        ]);
